...
/**
  \file Element_Breadcrumb.h Pathfinding element
  \author Trent R. Small
  \author Ezra S. Stallings.
  \date (C) 2014 All rights reserved.
  \lgpl
 */
#ifndef ELEMENT_BREADCRUMB_H
#define ELEMENT_BREADCRUMB_H
...
{
  template <class CC>
  class Element_Breadcrumb : public Element<CC>
  {
   public:
   ...
   protected:
    ...
    public:
      static Element_Breadcrumb THE_INSTANCE;
    ...
    Element_Breadcrumb() :
      Element<CC>(MFM_UUID_FOR("BreadcrumbRed", 1)),
  ...
  template <class CC>
  Element_Breadcrumb<CC> Element_Breadcrumb<CC>::THE_INSTANCE;
}

#endif /* ELEMENT_BREADCRUMB_H */
